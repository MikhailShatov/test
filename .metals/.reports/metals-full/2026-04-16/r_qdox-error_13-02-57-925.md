error id: file:///C:/TestProjects/kafka_test/src/main/java/org/example/kafkamock/service/KafkaConsumerService.java
file:///C:/TestProjects/kafka_test/src/main/java/org/example/kafkamock/service/KafkaConsumerService.java
...
```java
offset: 0
uri: file:///C:/TestProjects/kafka_test/src/main/java/org/example/kafkamock/service/KafkaConsumerService.java
text:
```scala
@@
```
...
QDox parse error in file:///C:/TestProjects/kafka_test/src/main/java/org/example/kafkamock/service/KafkaConsumerService.java